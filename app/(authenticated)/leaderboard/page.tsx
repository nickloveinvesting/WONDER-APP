      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
        ...
        <Card variant="gradient" className="mt-6">
          <p className="text-slate-700 font-medium text-sm leading-relaxed">
            <strong className="text-slate-900">Influence Score:</strong> Your influence grows as you contribute thoughtfully to conversations. Quality insights, helpful perspectives, and meaningful engagement all increase your influence in the Ponder community.
          </p>
        </Card>
      </div>
    </div>

  ...
  return (
    <div className="container mx-auto px-4 py-8 lg:px-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-argued-navy font-medium">Manage your philosophical identity and achievements</p>
      </div>

      {/* Profile Stats Grid */}
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        <div className="bg-white rounded-xl p-6 border border-argued-cream shadow-sm">
          <div className="text-argued-navy text-sm font-bold mb-2">Username</div>
        ...
        <div className="bg-white rounded-xl p-6 border border-argued-cream shadow-sm">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-argued-navy text-sm font-bold">DeLO Rating</span>
          </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-argued-cream shadow-sm">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-argued-navy text-sm font-bold">Reputation</span>
          </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-argued-cream shadow-sm">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-argued-navy text-sm font-bold">Debates</span>
          </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-argued-cream shadow-sm">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center pb-3 border-b border-argued-cream">
              <span className="text-argued-navy font-medium">Debates Participated</span>
              <span className="font-bold text-argued-navy">{profile.debates_participated || 0}</span>
            </div>
            <div className="flex justify-between items-center pb-3 border-b border-argued-cream">
              <span className="text-argued-navy font-medium">Debates Won</span>
        ...
        <div className="bg-white rounded-xl p-6 border border-argued-cream shadow-sm">
          ...
          <div className="space-y-3">
            <div className="pb-3 border-b border-argued-cream">
              <span className="text-argued-navy text-sm font-bold">Email</span>
              <p className="font-medium text-argued-navy">{user.email}</p>
            </div>
            <div className="pb-3 border-b border-argued-cream">
              <span className="text-argued-navy text-sm font-bold">Member Since</span>
              <p className="font-medium text-argued-navy">
                {new Date(profile.created_at).toLocaleDateString()}
              </p>
            </div>
            <div>
              <span className="text-argued-navy text-sm font-bold">Account Status</span>
